...
module AnalyzeHelper
  ...
  def colors
    @colors ||= [
      "#49416D", "#FFC857", "#920020", "#00B0B3", "#B2D236", "#004D61", "#FFB3CC", "#FF6F00", "#7BAFDE", "#332288",
       "#D155FF", "#999933", "#117733", "#882255", "#5289C7", "#F6C141", "#4EB265", "#E8601C", "#AE76A3",
      "#90C987", "#BF360C", "#3E2723", "#827717", "#44AA99", "#AA4499", "#00897B",  "#263238", "#CC6699"
    ]
  end
